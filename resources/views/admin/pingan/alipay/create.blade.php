...
@section('content')
    ...
    <!--<button type="button" id="payLogButton" class="btn db" style="font-size: 18px;">和店员已确认，立即买单</button>-->
        <input type="hidden" value="<?php echo $_GET['external_id']?>" id="external_id">
    ...
    <div class="keyboard">
        <ul>
            ...
            <li class="confirm" data-txt="确认" id="payLogButton" onclick="pay()"></li>
            {{--<li class="confirm" data-txt="确认" >
                <button onclick="pay()"  id="payLogButton"  style="width: 100%;height: 100%;background-color: transparent;border: none;outline: medium"></button>
            </li>--}}
            <li data-num="4"></li>
            <li data-num="5"></li>
            <li data-num="6"></li>
