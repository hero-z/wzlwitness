...
//                                            city: "010"//城市，默认：“全国”
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>推广员ID(必填，自助注册或不清楚的请直接填入数字10)</label>
                                <input required="required" placeholder="" class="form-control" value="<?php echo $_GET['user_id']?>" name="user_id" id="user_id"
                                       type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                        </form>
