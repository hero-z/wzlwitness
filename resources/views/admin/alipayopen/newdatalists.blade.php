                            ...
                            @foreach($list as $v)
                                <tr class="gradeX">
                                    ...
                                    <td class="am-u-sm-1">
                                        ...
                                        @elseif($v->type==701)
                                            现金
                                        @elseif($v->type==801)          {{--add by Neomor--}} 
                                            微众支付宝          {{--add by Neomor--}}
                                        @elseif($v->type==802)          {{--add by Neomor--}}
                                            微众微信          {{--add by Neomor--}}
                                        @elseif($v->type==803)          {{--add by Neomor--}}
                                            微众支付宝机具          {{--add by Neomor--}}
                                        @elseif($v->type==804)          {{--add by Neomor--}}
                                            微众微信机具          {{--add by Neomor--}}
                                        @endif
