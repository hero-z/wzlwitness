    ...
    <div class="wrapper wrapper-content">
        <div class="row">
            <div class="col-sm-10">
                ...
                <div class="row">                  {{--add by Neomor--}}
                    <div class="col-sm-6">                  {{--add by Neomor--}}
                        <div class="row row-sm text-center">                  {{--add by Neomor--}}
                            <div class="col-title">                  {{--add by Neomor--}}
                                <h3>微众银行</h3>                  {{--add by Neomor--}}
                            </div>                  {{--add by Neomor--}}
                            <div class="col-xs-6">                  {{--add by Neomor--}}
                                <div class="panel padder-v item bg-primary">                  {{--add by Neomor--}}
                                    <div class="h1 text-fff font-thin h1">{{$wbstore_y}}</div>                  {{--add by Neomor--}}
                                    <span class="text-muted text-xs">昨日店铺</span>                  {{--add by Neomor--}}
                                    <div class="top text-right w-full">                  {{--add by Neomor--}}
                                        <i class="fa fa-caret-down text-warning m-r-sm"></i>                  {{--add by Neomor--}}
                                    </div>                  {{--add by Neomor--}}
                                </div>                  {{--add by Neomor--}}
                            </div>                  {{--add by Neomor--}}
                            <div class="col-xs-6">                  {{--add by Neomor--}}
                                <div class="panel padder-v item">                  {{--add by Neomor--}}
                                    <div class="font-thin h1">{{$wbtotal_y}}</div>                  {{--add by Neomor--}}
                                    <span class="text-muted text-xs">昨日交易</span>                  {{--add by Neomor--}}
                                    <div class="bottom text-left">                  {{--add by Neomor--}}
                                        <i class="fa fa-caret-up text-warning m-l-sm"></i>                  {{--add by Neomor--}}
                                    </div>                  {{--add by Neomor--}}
                                </div>                  {{--add by Neomor--}}
                            </div>
                            <div class="col-xs-6">                  {{--add by Neomor--}}
                                <div class="panel padder-v item">                  {{--add by Neomor--}}
                                    <div class="h1 text-info font-thin h1">{{$wbstores}}</div>                  {{--add by Neomor--}}
                                    <span class="text-muted text-xs">店铺数量</span>                  {{--add by Neomor--}}
                                    <div class="top text-right w-full">                  {{--add by Neomor--}}
                                        <i class="fa fa-caret-down text-warning m-r-sm"></i>                  {{--add by Neomor--}}
                                    </div>                  {{--add by Neomor--}}
                                </div>                  {{--add by Neomor--}}
                            ...
                            <div class="col-xs-6">                  {{--add by Neomor--}}
                                <div class="panel padder-v item bg-info">                  {{--add by Neomor--}}
                                    <div class="h1 text-fff font-thin h1">{{$wbtotal_amount}}</div>                  {{--add by Neomor--}}
                                    <span class="text-muted text-xs">总交易额</span>                  {{--add by Neomor--}}
                                    <div class="top text-right w-full">                  {{--add by Neomor--}}
                                        <i class="fa fa-caret-down text-warning m-r-sm"></i>                  {{--add by Neomor--}}
                                    </div>                  {{--add by Neomor--}}
                                </div>                  {{--add by Neomor--}}
