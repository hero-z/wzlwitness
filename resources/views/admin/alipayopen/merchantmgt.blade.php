                                    ...
                                    @foreach($data as $v)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{url('/admin/alipayopen/merchantshopsetway?id='.$v['id'])}}">
                                                    <button class="btn btn-info " type="button"><i class="fa fa-paste"></i>扫码枪通道配置</button>
                                                </a>
                                                @endpermission
                                                @permission("cashier")
                                                <a href="{{url('/admin/alipayopen/merchantshopwaymgt?id='.$v['id'])}}">
                                                    <button class="btn btn-info " type="button"><i class="fa  fa-pencil-square"></i>收银通道管理</button>
                                                </a>
