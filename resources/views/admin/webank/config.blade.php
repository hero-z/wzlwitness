                    ...
                    <div class="col-sm-12">
                        <form role="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="请输入微信通知模板ID" class="form-control"  value="{{$wx->template_id}}" id="template_id1" type="text" name="template_id1">
                            </div>
                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form role="form" method="post">
                            ...
                            <div class="form-group">
                                <label>微信通知模板ID</label>
                                <input placeholder="请输入微信通知模板ID" class="form-control"  value="{{$wx->template_id}}" id="template_id2" type="text" name="template_id2">
                            </div>
                            <div class="form-group">
                                <label>证书文件XXXXXX.crt</label>
            ...
            $.post("{{route('webankconfigpost')}}",
                    {
                        ...
                        template_id: $("#template_id"+id).val()
                    },
                    function (result) {
                        if (result.status == 1) {
