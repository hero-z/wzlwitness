    ...
    <div class="widget am-cf">
        <form method='post' class="am-form tpl-form-line-form" action="{{route('userprofit')}}">
            ...
            <div class="am-input-group am-datepicker-date am-u-sm-12 am-u-md-12 am-u-lg-2 doc-example">
                <input size="16" type="text" id="time_start" name="time_start" placeholder="开始日期" value="{{$time_start or ''}}"  class="form-datetime-short am-form-field">
                ...
                <script>
                    (function($){
                        ...
                        $('.form-datetime-short').datetimepicker({
                            language:  'zh-CN',
                            format: 'yyyy-mm-dd'
                        });
                    }(jQuery));
            ...
            <div class="am-input-group am-datepicker-date am-u-sm-12 am-u-md-12 am-u-lg-2 doc-example">
                <input size="16" type="text" id="time_end" name="time_end" placeholder="结束日期" value="{{$time_end or ''}}"  class="form-datetime-short am-form-field">
            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                ...
                <button type="submit" class="am-btn am-btn-primary tpl-btn-bg-color-success ">查看清算结果</button>
