                                    ...
                                    @foreach($datapage as $v)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('webankqueryclearing',['store_id'=>$v->store_id])}}">
                                                    <button  type="button" class="btn btn-outline btn-success">清算结果</button>
                                                </a>
                                                @endpermission
                                                ...
                                                <a href="{{route('webankeditsubdevconfig',['store_id'=>$v->store_id])}}">
                                                    <button type="button" class="btn btn-outline btn-primary">修改店公众号
                                                    </button>
                                                </a>
                                                @endpermission
                                                @if($v->pid==0)
