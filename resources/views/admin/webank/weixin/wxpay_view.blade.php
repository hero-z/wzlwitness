...
@section('content')
    ...
    <div class="weui-wepay-pay">
        <div class="weui-wepay-pay__bd">
            <div class="weui-wepay-pay__inner">
                ...
                <div class="ipt" id="ttoday">
                    <span>消费金额</span><i></i>

                    <div class="total_fee">¥<span id="total_fee"></span></div>
        ...
        {{--<div class="weui-cells">--}}
            {{--<div class="weui-cell">--}}
               {{--<div class="weui-wepay-pay__intro">您在本店积分为：{{$point1}}分</div>--}}
            {{--</div>--}}
            {{--<div class="weui-cell">--}}
               {{--<div class="weui-wepay-pay__intro">您的会员积分为：{{$point}}分</div>--}}
            {{--</div>--}}
        {{--</div>--}}
    ...
    <div class="keyboard">
        <ul>
            ...
            <li class="confirm" data-txt="确认" onclick="callpay()"></li>
