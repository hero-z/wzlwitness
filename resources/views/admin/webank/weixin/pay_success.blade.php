    ...
    <div class="msg_success">
        <div class="weui-msg">
            ...
            <div class="weui-msg__text-area">
                ...
                <p class="weui-msg__title">{{$price}}元</p>
                <p class="weui-msg__desc">欢迎下次光临</p>
            </div>
            <div class="weui-msg__opr-area">
                <p class="weui-btn-area">
                    <a href="javascript:;" onclick="closed()" class="weui-btn weui-btn_primary">确认</a>
                    <a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxbcbc0ff447b02034&redirect_uri=https%3a%2f%2pay.ft361.com%2fadmin%2fweixin%2foauth_callback&response_type=code&scope=snsapi_userinfo&state=123#wechat_redirect" class="weui-btn weui-btn_default">辅助操作</a>
                </p>
            </div>
        </div>
        @foreach($ad as $v)
