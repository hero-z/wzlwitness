    ...
    <div class="col-sm-6">
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>商户店铺资料-商户服务协议<a href="http://wiki.qimengwifi.com/download/%E7%89%B9%E7%BA%A6%E5%95%86%E6%88%B7%E6%89%AB%E7%A0%81%E6%94%AF%E4%BB%98%E6%9C%8D%E5%8A%A1%E5%8D%8F%E8%AE%AE.docx">点我下载</a></h5>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form action="" method="post">
                            ...
                            {{--</div>--}}
                            <div class="form-group" >
                                <label>门店分类(必选，无完全相同分类请选择近似分类)</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <input required="required" placeholder="请在地图上点击选择地址或者直接填入" class="form-control" name="address" id="address" type="text">
                                </div>
...
//                                            city: "010"//城市，默认：“全国”
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>推广员ID(必填，自助注册或无推广员ID的请填入数字10)</label>
