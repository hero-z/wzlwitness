            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="col-sm-3">
                        ...
                        <a href="<?php echo e(route("addMerchine")); ?>"  class="btn btn-sm btn-success" style="color:white;">添加设备</a>
                        <?php endif; // Entrust::can ?>
                        <a href="<?php echo e(route("merchineConfig")); ?>"  class="btn btn-sm btn-danger" style="color:white;">设备配置</a>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="pie"><?php echo e($v->updated_at); ?></span></td>
                                                <th>
                                                    ...
                                                    <a href="<?php echo e(url('/admin/ticket/editMerchine?id='.$v->id)); ?>">
    ...
    <script type="text/javascript">
        function del(id) {
            ...
            layer.confirm('确定要删除吗?', {
                ...
                $.get("<?php echo e(route('deleteMerchine')); ?>", {_token: "<?php echo e(csrf_token()); ?>", id: id},
                        function (data) {
                            if(data.success){
                                window.location.href = "<?php echo e(Route('ticketIndex')); ?>";
                            }else{
