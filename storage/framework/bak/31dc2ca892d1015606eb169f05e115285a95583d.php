...
<?php $__env->startSection('title','资质上传'); ?>
                    ...
                    <div class="col-sm-12">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <label>门头照片</label>
                                <input type="hidden" required="required" size="50" name="store_header" id="store_header">
                                <!-- 图片上传按钮 -->
...
<?php $__env->startSection('js'); ?>
    <script>
        function addpost() {
            $.post("<?php echo e(route("webankdouploadfiles")); ?>", {
                    ...
                    function (result) {
                        if (result.success==1) {
                            if($('#code_from').val()=='1'){
                                window.location.href = "<?php echo e(route('webankstoresuccess')); ?>";
                            }else{
                                window.location.href = "<?php echo e(route('webankQrCode',['code_number'=>$code_number])); ?>";
                            }
                        } else {
