        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="col-sm-3">
                        <a href="<?php echo e(url('/admin/alipayopen/CashierAdd?store_id='.$_GET['store_id'].'&store_name='.$_GET['store_name'].'&id='.$id)); ?>"
                           class="btn btn-sm btn-primary">添加收银员</a>
                        <a href="<?php echo e(url('/admin/alipayopen/bindCashierIndex?store_id='.$_GET['store_id'].'&store_name='.$_GET['store_name'])); ?>"
                                    ...
                                    <?php $__currentLoopData = $datapage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php endif; ?>
                                                   <?php if($v->store_type=="salipay"): ?>
                                                        <a href="<?php echo e(url('admin/alipayopen/skm?id='.$id.'&merchant_id='.$v->id)); ?>">
                                                            <button type="button" class="btn  btn-success">收款码</button>
                                                        </a>
                                                    <?php endif; ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if($v->store_type=="pufa"): ?>
                                                    <a href="<?php echo e(url('/admin/pufa/cashierQr?store_id='.$v->store_id.'&cashier_id='.$v->id)); ?>">
                                                        <button type="button" class="btn  btn-success">收款码</button>
                                                    </a>
                                                <?php endif; ?>
                                                <a href="">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="dataTables_paginate paging_simple_numbers"
                                    ...
                                    <?php echo e($paginator->appends(['store_id'=>$store_id,'store_name'=>$store_name])->render()); ?>
