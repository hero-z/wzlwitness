...
<?php $__env->startSection('title','资质文件上传'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-sm-6">
        ...
        <input type="hidden" id="store_id" value="<?php echo e($store['store_id']); ?>">
                    ...
                    <div class="col-sm-12">
                        <form action="" method="post">
                            <div class="form-group">
                                <label>门头照片</label>
                                <input type="hidden" required="required" value="<?php echo e($store['store_header']); ?>" size="50" name="store_header" id="store_header">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload5" type="file" name="image"
                                       data-url="<?php echo e(route('webankdouploadfile')); ?>"
                                       multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files5"><?php if($store['store_header']): ?><img class="images_zone" width="30px" src="<?php echo e(url($store['store_header'])); ?>"><?php endif; ?></div>
                            ...
                            <div class="form-group">
                                <label>手持身份证照</label>
                                <input type="hidden" required="required" value="<?php echo e($store['sfz3']); ?>" size="50" name="sfz3" id="sfz3">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload10" type="file" name="image"
                                       data-url="<?php echo e(route('webankdouploadfile')); ?>"
                                       multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files10"><?php if($store['sfz3']): ?><img class="images_zone" width="30px" src="<?php echo e(url($store['sfz3'])); ?>"><?php endif; ?></div>
                                <div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                <label>身份证正面照</label>
                                <input type="hidden" required="required" value="<?php echo e($store['sfz1']); ?>" size="50" name="sfz1" id="sfz1">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload3" type="file" name="image"
                                       data-url="<?php echo e(route('webankdouploadfile')); ?>"
                                       multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files3"><?php if($store['sfz1']): ?><img class="images_zone" width="30px" src="<?php echo e(url($store['sfz1'])); ?>"><?php endif; ?></div>
                                <div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                <label>身份证反面照</label>
                                <input type="hidden" required="required" value="<?php echo e($store['sfz2']); ?>" size="50" name="sfz2" id="sfz2">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload4" type="file" name="image"
                                       data-url="<?php echo e(route('webankdouploadfile')); ?>"
                                       multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files4"><?php if($store['sfz2']): ?><img class="images_zone" width="30px" src="<?php echo e(url($store['sfz2'])); ?>"><?php endif; ?></div>
                                <div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                <label>营业执照</label>
                                <input type="hidden" required="required" size="50" value="<?php echo e($store['licence']); ?>" name="licence" id="licence">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload1" type="file" name="image"
                                       data-url="<?php echo e(route('webankdouploadfile')); ?>"
                                       multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files1"><?php if($store['licence']): ?><img class="images_zone" width="30px" src="<?php echo e(url($store['licence'])); ?>"><?php endif; ?></div>
                                <div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
...
<?php $__env->startSection('js'); ?>
    <script>
        function addpost() {
            $.post("<?php echo e(route("webankmerchantfilepost")); ?>", {
    ...
    <script type="text/javascript">
        ...
        function publicfileupload(fileid, imgid, postimgid, class1, class2) {
            //图片上传
            $(fileid).fileupload({
                formData: {store: $("#external_id").val(), _token: "<?php echo e(csrf_token()); ?>"},
                dataType: 'json',
                add: function (e, data) {
