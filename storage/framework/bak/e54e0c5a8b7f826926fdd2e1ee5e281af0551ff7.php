                    ...
                    <div class="col-sm-12">
                        <form role="form" method="post">
                            ...
                            <div class="form-group">
                                <label>app_id</label>
                                <input placeholder="请输入您app_id" value="<?php echo e($c->app_id); ?>" class="form-control" id="app_id" name="app_id"
                                       type="text">
                            </div>
                            <div class="form-group">
                                <label>secret</label>
                                <input placeholder="请输入secret" value="<?php echo e($c->secret); ?>" class="form-control" id="secret"
                                       name="secret"
                                       type="text">
                            </div>
                            <div class="form-group">
                                <label>merchant_id</label>
                                <input placeholder="请输入您merchant_id" value="<?php echo e($c->merchant_id); ?>" class="form-control" id="merchant_id" name="merchant_id"
                                       type="text">
                            </div>
                            <div class="form-group">
                                <label>notify_url</label>
                                <input placeholder="请输入您notify_url" value="<?php echo e($c->notify_url); ?>" class="form-control" id="notify_url"
                                       name="notify_url"
                                       type="text">
                            </div>
                            <div class="form-group">
                                <label>key</label>
                                <input placeholder="请输入key" class="form-control"  value="<?php echo e($c->key); ?>" id="key" type="text" name="key">
                            </div>
                            <div class="form-group">
                                <label>证书文件apiclient_cert.pem</label>
                                <input type="text" size="50" name="cert_path" value="<?php echo e($c->cert_path); ?>" id="cert_path">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload" type="file" name="file" data-url="<?php echo e(route('uploadfile')); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" size="50" name="key_path" value="<?php echo e($c->key_path); ?>" id="key_path">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload1" type="file" name="file" data-url="<?php echo e(route('uploadfile')); ?>"
                                       data-form-data='{"_token": "<?php echo e(csrf_token()); ?>"}' multiple="true">
                                <!-- 图片展示模块 -->
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        function addpost() {
            $.post("<?php echo e(route('spsetPost')); ?>",
                    {
