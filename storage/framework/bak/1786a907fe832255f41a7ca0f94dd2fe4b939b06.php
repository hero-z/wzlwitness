                                        ...
                                        <tr>
                                            ...
                                            <?php if($v->audit_status=='AUDIT_FAILED'||$v->apply_id==""): ?>
                                                <th>
                                                    ...
                                                    <?php if (\Entrust::can("alipayShopChangeStatus")) : ?>
                                            ...
                                            <?php elseif($v->shop_id): ?>
                                                <th>
                                                    ...
                                                    <a href="<?php echo e(url("admin/alipayopen/salipayBranchIndex?pid=".$v->id)); ?>">
                                                        <button type="button" class="btn btn-info">分店管理</button>
                                                    </a>
                                                    <a href="<?php echo e(url('admin/alipayopen/CashierIndex?store_id='.$v->store_id.'&store_name='.$v->main_shop_name.'&id='.$v->id)); ?>">
                                                        <button type="button" class="btn btn-info">收银员管理</button>
                                                    </a>
                                                    <?php if (\Entrust::can("alipayShopChangeStatus")) : ?>
                                                    <a href="<?php echo e(url('/admin/alipayopen/storeChangeStatus?id='.$v->id)); ?>">
                                                        <button type="button" class="btn btn-info">删除</button>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="dataTables_paginate paging_simple_numbers"
                                ...
                                <?php echo e($paginator->appends(['shopname'=>$shopname])->render()); ?>
