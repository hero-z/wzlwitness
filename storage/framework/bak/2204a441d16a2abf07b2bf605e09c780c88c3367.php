                    ...
                    <div class="col-sm-12">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <label>APP_ID</label>
                                <input value="<?php echo e($c['app_id']); ?>" id="app_id" placeholder="请填写支付宝开放平台应用的app_id"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="rsaPrivateKey" style="min-height: 300px" placeholder="请填写软件生成的应用私钥"
                                          class="form-control" name="rsaPrivateKey"><?php echo e($c['rsaPrivateKey']); ?></textarea>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>RSA应用公钥</label>
                                <textarea id="pinganrsaPublicKey" style="min-height: 100px" placeholder="请填写RSA应用公钥"
                                          class="form-control" name="pinganrsaPublicKey"><?php echo e($c['pinganrsaPublicKey']); ?></textarea>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>微信公众号APP_ID</label>
                                <input value="<?php echo e($c['wx_app_id']); ?>" id="wx_app_id" placeholder="请填写微信众号app_id"
                                       class="form-control" name="wx_app_id" type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>微信公众号secret</label>
                                <input value="<?php echo e($c['wx_secret']); ?>" id="wx_secret" placeholder="请填写请填写微信众号secret"
...
<?php $__env->startSection('js'); ?>
    <script>
        function addpost() {
            $.post("<?php echo e(route('savepinganconfig')); ?>",
                    {
                        _token: '<?php echo e(csrf_token()); ?>',wx_app_id:$("#wx_app_id").val(),wx_secret: $("#wx_secret").val(),app_id: $("#app_id").val()
