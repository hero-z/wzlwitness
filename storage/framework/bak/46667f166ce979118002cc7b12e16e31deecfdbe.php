        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <form action="<?php echo e(route("oauthlist")); ?>" method="post">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        <?php if (\Entrust::can("oauthlistRestore")) : ?>
                                    ...
                                    <?php $__currentLoopData = $datapage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($v->pid==0): ?>
                                                 <?php if (\Entrust::can("oauthlistBranch")) : ?>
                                                ...
                                                <?php endif; // Entrust::can ?>
                                                <?php if (\Entrust::can("oauthlistEdit")) : ?>
                                                ...
                                                <?php endif; // Entrust::can ?>
                                                <?php if (\Entrust::can("oauthlistChangeStatus")) : ?>
