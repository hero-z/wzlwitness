                    ...
                    <div class="col-sm-12">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" required="required" size="50" value="<?php echo e($list->logo1); ?>" name="oldpic1" id="oldpic1">
                                <!-- 图片上传按钮 -->
                                ...
                                <!-- 图片展示模块 -->
                                <div class="files" ><img class="images_zone" id="oldimg1" width="30px" src="<?php echo e(url($list->logo1)); ?>"></div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" required="required" size="50" value="<?php echo e($list->logo2); ?>" name="oldpic2" id="oldpic2">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload2" type="file" name="image" data-url="<?php echo e(route('uploads')); ?>"
                                       data-form-data='{"_token": "<?php echo e(csrf_token()); ?>"}' multiple="true" >
                                <!-- 图片展示模块 -->
                                <div class="files2" ><img class="images_zone" id="oldimg2" width="30px" src="<?php echo e(url($list->logo2)); ?>"></div>
                                <div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                    ...
                    function (result) {
                        if (result.success==1) {
                            ...
                            layer.confirm('修改成功', {
                                ...
                                window.location.href = "<?php echo e(route('logoIndex')); ?>";
                            }, function () {
