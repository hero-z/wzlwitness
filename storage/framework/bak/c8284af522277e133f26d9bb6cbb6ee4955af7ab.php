                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="row row-sm text-center">
                            ...
                            <div class="col-xs-6">
                                <div class="panel padder-v item bg-primary">
                                    <div class="h1 text-fff font-thin h1"><?php echo e($fstore_y); ?></div>
                                    <span class="text-muted text-xs">昨日店铺</span>
                                    <div class="top text-right w-full">
                                        <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                    </div>
                            ...
                            <div class="col-xs-6">
                                <div class="panel padder-v item">
                                    <div class="font-thin h1"><?php echo e($ftotal_y); ?></div>
                                    <span class="text-muted text-xs">昨日交易</span>
                                    <div class="bottom text-left">
                                        <i class="fa fa-caret-up text-warning m-l-sm"></i>
                                    </div>
                            ...
                            <div class="col-xs-6">
                                <div class="panel padder-v item">
                                    <div class="h1 text-info font-thin h1"><?php echo e($fstores); ?></div>
                                    <span class="text-muted text-xs">店铺数量</span>
                                    <div class="top text-right w-full">
                                        <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                    </div>
                            ...
                            <div class="col-xs-6">
                                <div class="panel padder-v item bg-info">
                                    <div class="h1 text-fff font-thin h1"><?php echo e($ftotal_amount); ?></div>
                                    <span class="text-muted text-xs">总交易额</span>
                                    <div class="top text-right w-full">
                                        <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                    </div>
