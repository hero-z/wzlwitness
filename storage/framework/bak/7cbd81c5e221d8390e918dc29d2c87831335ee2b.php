...
<div class="am-g tpl-g">
    ...
    <div class="tpl-login">
        <div class="tpl-login-content">
            ...
            <form class="am-form tpl-form-line-form" method="post" action="<?php echo e(route('setPasswordPost')); ?>">
                ...
                <?php if(session('code')): ?>
                    <span class="help-block">
                                        <strong><?php echo e(session('code')); ?></strong>
                                    </span>
                <?php endif; ?>
                <div class="am-form-group">
                ...
                <div class="am-form-group tpl-login-remember-me">
                    <label for="remember-me">
                        <a href="<?php echo e(url('merchant/login')); ?>">登陆账号</a>
                    </label>
...
<script type="text/javascript">
    ...
    function sendCode(thisBtn) {
        ...
        if (reg.test(phone)) {
            $.post("<?php echo e(url('api/Sms/send')); ?>", {phone: phone},
                function (data) {
                    if (!data.status_code) {
                        alert(data.message);
                        return false;
