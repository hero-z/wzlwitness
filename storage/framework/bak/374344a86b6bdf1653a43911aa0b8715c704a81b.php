...
<?php $__env->startSection('title','商户注册门店'); ?>
        ...
        <div class="ibox float-e-margins">
            <?php if(session('info')): ?>
                <div class="ibox-title">
                    <h5 style="color: red; text-align: center"><?php echo e(session('info')); ?></h5>
                </div>
            <?php endif; ?>
            <div class="ibox-title">
                <h5>商户店铺资料</h5><?php if($name): ?> (推广员:<?php echo e($name); ?>) <?php endif; ?>
            </div>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="身份证号,其他类型证件号" class="form-control" name="id_no" id="id_no"
                                           value="<?php echo e(old('id_no')); ?>"      type="text">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="商户全称" class="form-control" name="merchant_name" id="merchant_name"
                                       value="<?php echo e(old('merchant_name')); ?>"  type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>商户简称</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <?php $__currentLoopData = $cates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <select class="form-control m-b" value="" onchange="getmcc(this.id,this.value)" name="MCC" id="MCC">
                                        ...
                                        <?php $__currentLoopData = $mcc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input required="required" placeholder="营业执照编号" class="form-control"
                                       value="<?php echo e(old('licence_no')); ?>" name="licence_no" id="licence_no"
                                       type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>店铺地址:</label>
                                <div class="row">
                                    <input required="required" value="<?php echo e(old('address')); ?>" placeholder="请在地图上点击选择地址" class="form-control" name="address" id="address" type="text">
                                </div>
...
//                                            city: "010"//城市，默认：“全国”
                            ...
                            <div class="form-group">
                                <label>联系人姓名:</label>
                                <input class="form-control" placeholder="联系人姓名" type="text" value="<?php echo e(old('contact_name')); ?>" required="required"  name="contact_name" id="contact_name">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>联系人手机号</label>
                                <input required="required" placeholder="联系人手机号" class="form-control"
                                       value="<?php echo e(old('contact_phone')); ?>"    name="contact_phone" id="contact_phone" type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>客服电话</label>
                                <input required="required" placeholder="客服电话" class="form-control"
                                       value="<?php echo e(old('service_phone')); ?>"  name="service_phone" id="service_phone" type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>推广员ID(必填)</label>
                                <input required="required" placeholder="" class="form-control" value="<?php if($user_id): ?> <?php echo e($user_id); ?> <?php endif; ?>" name="user_id" id="user_id"
                                       type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <select class="form-control m-b" value="" onchange="getdata(this.id,this.value)" name="province" id="province">
                                        ...
                                        <?php $__currentLoopData = $provincelists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            <option value="<?php echo e($v->areaCode); ?>"><?php echo e($v->areaName); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                    </select>
...
//                address=$("#province option:selected").html()+$("#city option:selected").html()+$("#county option:selected").html();
        ...
        function getdata(id,value) {
            ...
            $.post("<?php echo e(route("getcitycountydata")); ?>", {id:value,_token: $("#token").val()}, function (data) {
                str='';
        ...
        function getcate(id,value) {
            ...
            $.post("<?php echo e(route("webankgetcate")); ?>", {id:value,_token: $("#token").val()}, function (data) {
                str='';
                if(sot=='secondcate'){
                    for (var k=0;k<data.length;k++) {
        ...
        function getmcc(id,value) {
            ...
            $.post("<?php echo e(route("webankgetmcc")); ?>", {id:value,_token: $("#token").val()}, function (data) {
                str='';
                if(sot=='secondmcc'){
                    for (var k=0;k<data.length;k++) {
    ...
    <script type="text/javascript">
        ...
        function publicfileupload(fileid, imgid, postimgid, class1, class2) {
            //图片上传
            $(fileid).fileupload({
                formData: {external_id: $("#external_id").val(), _token: "<?php echo e(csrf_token()); ?>"},
                dataType: 'json',
                add: function (e, data) {
