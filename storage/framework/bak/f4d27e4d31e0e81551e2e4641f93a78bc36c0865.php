...
<div class="am-g tpl-g">
    ...
    <div class="tpl-login">
        <div class="tpl-login-content">
            ...
            <img src="<?php echo e(url($logo->logo1)); ?>" style=" max-width: 159px;  height: 205px; margin: 0 auto; margin-bottom: 20px">
            </div>
            <form class="am-form tpl-form-line-form" role="form" method="POST" action="<?php echo e(url('merchant/login')); ?>">
                ...
                <?php if($errors->has('phone')): ?>
                    <?php if( $errors->first('phone')=="These credentials do not match our records."): ?>
