...
<?php $__env->startSection('content'); ?>
    <div style="text-align: center">
        <img id="img"
             src="data:image/png;base64, <?php echo base64_encode(QrCode::format('png')->size(500)->generate($code_url)); ?> ">
    </div>
    <div class="col-sm-6">
		...
		<div class="well well-lg">
                     <h3> URL授权</h3>
                         <a href=<?php echo e($code_url); ?> target="_blank"><?php echo e($code_url); ?></a>
                </div>
                <div class="well well-lg">
                    <h3>
                        开口碑店流程
