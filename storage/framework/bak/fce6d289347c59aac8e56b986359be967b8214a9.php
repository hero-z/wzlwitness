        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <?php if (\Entrust::can("pinganRestore")) : ?>
                    ...
                    <?php endif; // Entrust::can ?>
                    <?php if (\Entrust::can('downloadBill')) : ?>
                    <a class="J_menuItem" href="<?php echo e(route('pingandownloadbill')); ?>"> <button type="button" class="btn btn-outline btn-default">对账单下载</button></a>
                    <?php endif; // Entrust::can ?>
                                ...
                                <?php if($datapage): ?>
                                    <?php $__currentLoopData = $datapage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (\Entrust::can("pinganStoreInfo")) : ?>
                                                ...
                                                <?php endif; // Entrust::can ?>
                                                <?php if($v->pid==0): ?>
                                                    <?php if (\Entrust::can("pinganBranch")) : ?>
                                                <a href="<?php echo e(url('admin/pingan/BranchIndex?pid='.$v->id)); ?>">
                                                    ...
                                                    <?php endif; // Entrust::can ?>
                                                <?php endif; ?>
                                                <?php if (\Entrust::can("oauthlistCashier")) : ?>
