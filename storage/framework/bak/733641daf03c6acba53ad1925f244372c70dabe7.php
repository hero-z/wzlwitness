...
<div class="am-g tpl-g">
    ...
    <header>
        ...
        <div class="am-fl tpl-header-logo">
            <a href="<?php echo e(url('/merchant/index')); ?>"><img src="<?php echo e(url('/amazeui/assets/img/logo.png')); ?>" alt=""></a>
        </div>
        <!-- 右侧内容 -->
                ...
                <ul class="sidebar-nav sidebar-nav-sub">
                    <li class="sidebar-nav-link">
                        <a href="<?php echo e(route('setWays')); ?>">
                            <span class="am-icon-angle-right sidebar-nav-link-logo"></span>通道设置
                        </a>
                    </li>
                    <li class="sidebar-nav-link">
                        <a href="">
