...
//                                            city: "010"//城市，默认：“全国”
                            ...
                            <div class="form-group">
                                ...
                                <input required="required" placeholder="" class="form-control" value="<?php echo e($user_id); ?>" name="user_id" id="user_id"
                                       type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                        </form>
...
//                address=$("#province option:selected").html()+$("#city option:selected").html()+$("#county option:selected").html();
                ...
                window.location.href = "<?php echo e(url('merchant/autoFile?external_id=')); ?>" + $("#external_id").val() + '&code_number=' + $("#code_number").val() +'&user_id='+$('#user_id').val()+'&name='+$('#name').val()+'&alias_name='+$('#alias_name').val()+'&service_phone='+service_phone +'&category_id='+$('#category_id').val()+'&id_card_name='+$('#sfzname').val()+'&id_card_num='+id_card_num+'&store_address='+$('#address').val();
            }
        }
        window.onload = get;
        function get() {
