                    ...
                    <div class="col-sm-12">
                        <form action="<?php echo e(route('insertAd')); ?>" method="post">
                            ...
                            <div class="form-group">
                                <label>开始时间</label>
                                <div class="col-sm-10">
                                <input size="16" type="text" id="time_start" name="time_start" value="<?php if(!empty($time_start)): ?><?php echo e($time_start); ?><?php else: ?><?php echo e(date('Y-m-d').' 00:00'); ?><?php endif; ?>"  class="form-datetime-lang am-form-field" required="required">
                            ...
                            <div class="form-group">
                                <label>结束时间</label>
                                <div class="col-sm-10">
                                <input size="16" type="text" id="time_end" name="time_end" value="<?php if(!empty($time_end)): ?><?php echo e($time_end); ?><?php else: ?><?php echo e(date('Y-m-d').' 23:59'); ?><?php endif; ?>"  class="form-datetime-lang am-form-field" required="required">
...
<?php $__env->startSection('js'); ?>
    <script>
        function addpost() {
            $.post("<?php echo e(route('insertAd')); ?>",
                    {
