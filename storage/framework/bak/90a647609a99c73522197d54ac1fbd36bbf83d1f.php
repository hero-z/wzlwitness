    ...
    <div class="col-sm-6">
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>商户店铺资料(必填)</h5>(推广员:<?php echo e($user_name); ?>)
            </div>
                    ...
                    <div class="col-sm-12">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="" required="required"  name="address" id="address">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
    ...
    <script>
        function addpost() {
            if($("#category_id").val()=='请选择分类'){
                ...
                window.location.href = "<?php echo e(url('admin/pingan/autoFile?external_id=')); ?>" + $("#external_id").val() + '&code_number=' + $("#code_number").val() +'&user_id='+$('#user_id').val()+'&name='+$('#name').val()+'&alias_name='+$('#alias_name').val()+'&service_phone='+service_phone +'&category_id='+$('#category_id').val()+'&id_card_name='+$('#sfzname').val()+'&id_card_num='+id_card_num+'&store_address='+$('#address').val();
