        ...
        <div class="widget am-cf">
            ...
            <div class="widget-head am-cf">
                <div class="widget-title am-fl">
                    <form action="<?php echo e(route('alipaysLs')); ?>" method="get">
            ...
            <div class="widget-body  widget-body-lg am-fr">
                ...
                <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black "
                    ...
                    <?php $__currentLoopData = $info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <tr class="gradeX">
                            ...
                            <td class="am-u-sm-2"><?php echo e($v->main_shop_name); ?></td>
                            <td class="am-u-sm-2">
                            ...
                            <?php endif; ?>
                            <?php if($v->pay_status==""||$v->pay_status==null): ?>
                            ...
                            <td class="am-u-sm-2"><?php echo e($v->remark); ?></td>
                        </tr>
                ...
                <ul class="am-pagination">
                    <?php if($info): ?>   <?php echo e($info->appends(['status'=>$status])->links()); ?><?php endif; ?>
                </ul>
            </div>
        </div>
    </div>
