                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo e(url('admin/alipayopen/neworderlist')); ?>">交易订单</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="<?php echo e(url('admin/alipayopen/oauthlist')); ?>">支付宝当面付</a>
                            </li>
                            <?php endif; // Entrust::can ?>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route('PingAnStoreIndex')); ?>">平安银行商户</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route('storelist')); ?>">浦发银行商户</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route('UnionPayStoreIndex')); ?>">银联支付商户</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route('ms_storelist')); ?>">厦门民生银行商户</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route('webankindex')); ?>">微众银行商户</a>
                            </li>
                            <!-- <li>
                                <a class="J_menuItem" href="<?php echo e(route('zxstorelist')); ?>">中信银行商户</a>
                            </li> -->
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <?php if (\Entrust::can('oauthlist')) : ?>
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route('AlipayWexinLists')); ?>">多码聚合</a>
                            </li>
                            <?php endif; // Entrust::can ?>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route('WxAppMenuList')); ?>">菜单管理</a>
                            </li>
                        </ul>
                    </li>
                    <?php endif; // Entrust::can ?>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <?php if (\Entrust::can('merchine')) : ?>
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route('ticketIndex')); ?>">易联云设备列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route("UprintIndex")); ?>">U印智能云设备列表</a>
                            </li>
                            <?php endif; // Entrust::can ?>
                            <?php if (\Entrust::can("jpushConfigs")) : ?>
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route("setJpushConfigs")); ?>">极光配置</a>
                            </li>
                            <?php endif; // Entrust::can ?>
                            <?php if (\Entrust::can("updateApp")) : ?>
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route("updateAppIndex")); ?>">APP更新</a>
                            </li>
                            <?php endif; // Entrust::can ?>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route("questionsIndex")); ?>">帮助中心</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <?php endif; // Entrust::can ?>
                            <?php if (\Entrust::can('logo')) : ?>
                            <li>
                                <a class="J_menuItem" href="<?php echo e(route('logoIndex')); ?>">网站logo设置</a>
                            </li>
                            <?php endif; // Entrust::can ?>
                        </ul>
                    </li>
