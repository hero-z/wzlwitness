                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control m-b"  id="type" name="type" required="required">
                                        ...
                                        <option value="bestpay" <?php if($list->type=="bestpay"): ?> selected="selected" <?php endif; ?>>翼支付</option>
                                        <option value="pufa" <?php if($list->type=="pufa"): ?> selected="selected" <?php endif; ?>>浦发银行</option>
                                    </select>
                                </div>
                            </div>
