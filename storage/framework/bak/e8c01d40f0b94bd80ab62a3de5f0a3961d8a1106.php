...
<?php $__env->startSection('content'); ?>
    <div class="widget am-cf">
        ...
        <form class="am-form tpl-form-line-form" action="<?php echo e(route('insertOldShop')); ?>" method="post">
            ...
            <div class="doc-example">
                <select required="required" data-am-selected="{searchBox: 1,maxHeight: 200}" style="display: none;" name="auth_shop">
                    ...
                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <option value="<?php echo e($v->app_auth_token); ?>*<?php echo e($v->auth_shop_name); ?>"><?php echo e($v->auth_shop_name); ?></option>
