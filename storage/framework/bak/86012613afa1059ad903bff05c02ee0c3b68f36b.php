            ...
            <div class="widget am-cf">
                <form method='post' class="am-form tpl-form-line-form" action="<?php echo e(route('orderlistssearch')); ?>">
                    ...
                    <div class="am-input-group am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <select data-am-selected="{btnSize: 'sm',searchBox: 1}" id="shop_branch" name="shop_branch"  style="display: none;" onchange="change()">
                        ...
                        <select data-am-selected="{btnSize: 'sm',searchBox: 1 }"  id="shop_cashier" name="shop_cashier"  style="display: none;" >
        ...
        function change(){
            ...
            $.post("<?php echo e(route('getpostdatamerchantCashier')); ?>", {id:$('#shop_branch').val(),_token: "<?php echo e(csrf_token()); ?>"},
                    function (data) {
                        ...
                        $("#shop_cashier").append('<option value="0">收银员</option>'+'<option value="0">收银员</option>'+str);
                    }, 'json');
