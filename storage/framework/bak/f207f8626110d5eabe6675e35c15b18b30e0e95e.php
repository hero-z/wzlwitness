                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form action="<?php echo e(url('admin/alipayopen/store')); ?>" method="post">
                            ...
                            <div class="form-group">
                                <label>品牌名</label>
                                <input msg="品牌名" id="istrue" placeholder="不填写则默认为“其它品牌”" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload" type="file" name="image" data-url="<?php echo e(route('upload')); ?>"
                            ...
                            <div class="form-group">
                                <label>主店名称</label>
                                <input msg="主店名称" required="required" placeholder="比如：肯德基；主店名里不要包含分店名"
                                       class="form-control" name="main_shop_name" id="main_shop_name"
                                       type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>经度纬度</label>
                                <input msg="经度纬度" required="required" placeholder="经度纬度；最长15位字符（包括小数点）"
                                       class="form-control" name="longitude_latitude" id="longitude_latitude"
                                       type="text">
                            ...
                            <div class="form-group">
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload1" type="file" name="image" data-url="<?php echo e(route('upload')); ?>"
                                       data-form-data='{"_token": "<?php echo e(csrf_token()); ?>"}' multiple="true">
                                <!-- 图片展示模块 -->
                            ...
                            <div class="form-group">
                                <label>店内照片</label>
                                <input type="hidden" size="50" required="required" name="audit_images1"
                                       id="audit_images1">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload2" type="file" name="image" data-url="<?php echo e(route('upload')); ?>"
                                       data-form-data='{"_token": "<?php echo e(csrf_token()); ?>"}' multiple="true">
                                <!-- 图片展示模块 -->
                            ...
                            <div class="form-group">
                                <label>内景照片1</label>
                                <input type="hidden" size="50" name="audit_images2" required="required"
                                       id="audit_images2">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload3" type="file" name="image" data-url="<?php echo e(route('upload')); ?>"
                                       data-form-data='{"_token": "<?php echo e(csrf_token()); ?>"}' multiple="true">
                                <!-- 图片展示模块 -->
                            ...
                            <div class="form-group">
                                <label>内景照片2</label>
                                <input type="hidden" size="50" name="audit_images3" required="required"
                                       id="audit_images3">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload4" type="file" name="image" data-url="<?php echo e(route('upload')); ?>"
                                       data-form-data='{"_token": "<?php echo e(csrf_token()); ?>"}' multiple="true">
                                <!-- 图片展示模块 -->
                            ...
                            <div class="form-group">
                                <label>营业时间</label>
                                <input class="form-control" required="required" name="business_time" id="business_time"
                                       type="text"
                            ...
                            <div class="form-group">
                                <label>停车</label>
                                <input class="form-control" name="parking" id="parking" type="text"
                                       placeholder="T表示支持，F表示不支持">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>门店其他的服务</label>
                            ...
                            <div class="form-group">
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload5" type="file" name="image" data-url="<?php echo e(route('upload')); ?>"
                                       data-form-data='{"_token": "<?php echo e(csrf_token()); ?>"}' multiple="true">
                                <!-- 图片展示模块 -->
                            ...
                            <div class="form-group">
                                <label>营业执照上名称</label>
                                <input type="text" required="required" size="50" name="licence_name" id="licence_name"
                                       placeholder="门店营业执照名称">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>营业执照编号</label>
                                <input type="text" required="required" size="50" name="licence_code" id="licence_code"
                                       placeholder="门店营业执照编号">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>营业执照过期时间</label>
                                <input type="text" placeholder="营业执照过期时间格式：2020-03-20" size="50" name="licence_expires"
                                       id="licence_expires">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload6" type="file" name="image" data-url="<?php echo e(route('upload')); ?>"
                                       data-form-data='{"_token": "<?php echo e(csrf_token()); ?>"}' multiple="true">
                                <!-- 图片展示模块 -->
                            ...
                            <div class="form-group">
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload7" type="file" name="image" data-url="<?php echo e(route('upload')); ?>"
                                       data-form-data='{"_token": "<?php echo e(csrf_token()); ?>"}' multiple="true">
                                <!-- 图片展示模块 -->
                            ...
                            <div class="form-group">
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload8" type="file" name="image" data-url="<?php echo e(route('upload')); ?>"
                                       data-form-data='{"_token": "<?php echo e(csrf_token()); ?>"}' multiple="true">
                                <!-- 图片展示模块 -->
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="is_operating_online" id="is_operating_online"
                                       type="text"
...
<?php $__env->startSection('js'); ?>
    <script>
        function addpost() {
            $.post("<?php echo e(url('admin/alipayopen/store')); ?>",
                    {
                    ...
                    function (result) {
                        if (result.code == 10000) {
                            ...
                            layer.confirm('保存成功！等待口碑审核！', {
                                ...
                                window.location.href = "<?php echo e(url('/admin/alipayopen/store')); ?>";
                            }, function () {
    ...
    <script>
        ...
        function getProvince() {
            $.post("<?php echo e(route("getProvince")); ?>", {_token: $("#token").val()}, function (data) {
                for (var key in data) {
        ...
        function getCity(areaCode) {
            $.post("<?php echo e(route("getCity")); ?>", {_token: $("#token").val(), areaCode: areaCode}, function (data) {
                for (var key in data) {
        ...
        function getCategory() {
            $.post("<?php echo e(route("getCategory")); ?>", {_token: $("#token").val()}, function (data) {
                for (var key in data) {
