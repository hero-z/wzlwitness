...
*/
//前台
use App\Http\Controllers\WeBank\WebankClearingController;
...
Route::group(['namespace' => 'AlipayOpen', 'middleware' => 'auth', 'prefix' => 'admin/alipayopen'], function () {
    ...
    Route::get('/merchantshopsetway', 'MerchantmanagementController@mmshopsetway')->name('mmshopsetway');//Add by Neomor 添加收银通道
    Route::post('/merchantshopsetwaypost', 'MerchantmanagementController@mmshopsetwaypost')->name('mmshopsetwaypost');//Add by Neomor 添加收银通道
    Route::get('/merchantshopwaymgt', 'MerchantmanagementController@mmshopwaymgt')->name('mmshopwaymgt');//Add by Neomor 添加收银通道
    Route::post('/merchantshopwaymgtpost', 'MerchantmanagementController@mmshopwaymgtpost')->name('mmshopwaymgtpost');//Add by Neomor 添加收银通道
...
Route::group(['namespace' => 'Weixin', 'prefix' => 'admin/weixin'], function () {
    Route::any('/wxusers','UserManagerController@updateWxSubscribers');
    Route::any('/updatemember','UserManagerController@updateMembersPoint');
...
//    Route::post('WxAppMenu', 'MenuController@getmenufromserver')->name('WxAppMenu');

    Route::get('WxAppMenuList', 'MenuController@menulist')->name('WxAppMenuList');
    Route::get('WxAppMenuListdd', 'MenuController@getmenufromserver')->name('WxAppMenuListdd');
...
Route::group(['namespace' => 'WeBank', 'prefix' => 'admin/webank'], function () {
    //进件
    Route::any('/merchantregister', 'WebankStoreController@merchantregister')->name("merchantregister");
    Route::any('/webankQrCode', 'WebankQrController@webankQrCode')->name("webankQrCode");
    Route::any('/weixin/publicPay', 'WebankPayController@publicPay')->name("webankpublicPay");
    Route::post('/weixin/dopay', 'WebankPayController@doPay')->name("webankdoPay");
    Route::any('/weixin/alipaysuccess', 'WebankPayController@alipaysuccess')->name("webankalipaysuccess");
    Route::any('/weixin/alipayerror', 'WebankPayController@alipayerror')->name("webankalipayerror");
    Route::post('/ali_callback', 'WebankNotifyController@ali_callback')->name("webankali_callback");

    Route::any('/getaccesstoken', 'WebankAccessTokenController@getaccesstoken')->name("webankgetaccesstoken");//add by Neomor 获取accesstoken

    Route::get('/getclearing','WebankClearingController@queryclearing')->name("webankgetclearing");

    Route::any('/weixin/weixinPay', 'WebankPayController@weixinPay')->name("webankweixinPay");
    Route::post('/weixin/wxdopay', 'WebankPayController@wxdoPay')->name("webankwxdoPay");
    Route::any('/weixin/wxpaysuccess', 'WebankPayController@wxpaysuccess')->name("webankwxpaysuccess");
    Route::any('/weixin/wxpayerror', 'WebankPayController@wxpayerror')->name("webankwxpayerror");
    Route::post('/wx_callback', 'WebankNotifyController@wx_callback')->name("webankwx_callback");

    Route::post('/getcate', 'WebankStoreController@getcate')->name("webankgetcate");
    Route::post('/getmcc', 'WebankStoreController@getmcc')->name("webankgetmcc");
    Route::get('/storesuccess', 'WebankStoreController@storesuccess')->name("webankstoresuccess");
});
//微众需要登录服务商
Route::group(['namespace' => 'WeBank', 'prefix' => 'admin/webank','middleware' => 'auth'], function () {
    //列表
    Route::any('/index', 'WebankStoreController@index')->name("webankindex");
    Route::any('/config', 'WebankStoreController@config')->name("webankconfig");
    Route::post('/configpost', 'WebankStoreController@configpost')->name("webankconfigpost");
    Route::post('/sendfile', 'WebankStoreController@sendfile')->name("webanksendfile");
    Route::get('/editcode', 'WebankStoreController@editcode')->name("webankeditcode");
    Route::post('/doeditcode', 'WebankStoreController@doeditcode')->name("upWebank");
    Route::post('/paystatus', 'WebankManageController@paystatus')->name("Webankpaystatus");
    Route::post('/deletestore', 'WebankManageController@deletestore')->name("DelWebankstore");
    Route::any('/restore', 'WebankManageController@restore')->name("webankRestore");
    Route::any('/storeback', 'WebankManageController@storeback')->name("webankstoreback");
    Route::any('/allstoreback', 'WebankManageController@allstoreback')->name("webankallstoreback");
    Route::any('/orderlist', 'WebankManageController@orderlist')->name("webankorderlist");
    Route::any('/merchantfile', 'WebankManageController@merchantfile')->name("webankmerchantfile");
    Route::post('/merchantfilepost', 'WebankManageController@merchantfilepost')->name("webankmerchantfilepost");
    Route::any('/eidtmerchantfile', 'WebankStoreController@editmerchantfile')->name("webankeditmerchantfile");
    Route::post('/eidtmerchantfilepost', 'WebankStoreController@editmerchantfilepost')->name("webankeditmerchantfilepost");
    Route::any('/cashierlist', 'WebankManageController@cashierlist')->name("webankcashierlist");
    Route::any('/cashierqr', 'WebankManageController@cashierqr')->name("webankcashierqr");
    ...
    Route::any('/qrlist', 'WebankManageController@qrlist')->name("webankqrlist");
    Route::post('/createqr', 'WebankManageController@createqr')->name("webankcreateqr");
    Route::any('/downloadqr', 'WebankManageController@downloadqr')->name("webankdownloadqr");

    Route::any('/editsubdevconfig', 'WebankStoreController@editsubdevconfig')->name("webankeditsubdevconfig");//add by Neomor 修改微信公众号
    Route::post('/editsubdevconfigpost', 'WebankStoreController@editsubdevconfigpost')->name("webankeditsubdevconfigpost");//add by Neomor 修改微信公众号

    Route::post('/webankDelete', 'WebankManageController@webankDelete')->name("webankDelete");  //add by Neomor 微众银行分店彻底删除
    Route::any('/wbtest','WebankBarcodepayController@wbQuery')->name('wbtest');

    Route::any('/webankqueryclearing','WebankClearingController@index')->name('webankqueryclearing');
//    Route::any('/editmerchantmp', 'WebankWeixinmpController@editmerchantmp')->name("webankeditmerchantmp"); //add by Neomor 修改微信公众号
//    Route::post('/eidtmerchantmppost', 'WebankWeixinmpController@editmerchantmppost')->name("webankeditmerchantmppost");//add by Neomor 修改微信公众号
});
//微众需要登录商户
Route::group(['namespace' => 'WeBank', 'prefix' => 'admin/webank','middleware' => 'auth.merchant'], function () {
    //列表
    Route::any('/register', 'WebankStoreController@register')->name("webankregister");
    Route::any('/bindcard', 'WebankStoreController@bindcard')->name("webankbindcard");
    Route::post('/merchantregister', 'WebankStoreController@merchantregister')->name("merchantregister");
    Route::any('/uploadfile', 'WebankStoreController@uploadfile')->name("webankuploadfile");
    Route::post('/douploadfile', 'WebankStoreController@douploadfile')->name("webankdouploadfile");
    Route::post('/douploadfiles', 'WebankStoreController@douploadfiles')->name("webankdouploadfiles");
});
//微众需要登录商户
