...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        ...
        'AopClient' => \Alipayopen\Sdk\AopClient::class,
        'AopEncrypt' => \Alipayopen\Sdk\AopEncrypt::class,
        'AlipayOfflineMarketShopCategoryQueryRequest' => \Alipayopen\Sdk\Request\AlipayOfflineMarketShopCategoryQueryRequest::class,
        'wxpayapi' => \WeixinPay\Lib\WxPayApi::class,
        'wxpayconfig' => \WeixinPay\Lib\WxPayConfig::class,
        'wxpayexcepition' => \WeixinPay\Lib\WxPayException::class,
