...
class WebankManageController extends WebankBaseController
{
    ...
    //彻底删除 add by Neomor 彻底删除 微众银行分店
    public function webankDelete(Request $request)               //彻底删除 add by Neomor 彻底删除 微众银行分店
    {                                                           //彻底删除 add by Neomor 彻底删除 微众银行分店
        $auth = Auth::user()->can('dropwebankstore');            //彻底删除 add by Neomor 彻底删除 微众银行分店
        if (!$auth) {                                            //彻底删除 add by Neomor 彻底删除 微众银行分店
            return json_encode([                                   //彻底删除 add by Neomor 彻底删除 微众银行分店
                'success' => 0,                                   //彻底删除 add by Neomor 彻底删除 微众银行分店
                "erro_message" => "您没有权限操作!"                  //彻底删除 add by Neomor 彻底删除 微众银行分店
            ]);                                                   //彻底删除 add by Neomor 彻底删除 微众银行分店
        }else{                                                    //彻底删除 add by Neomor 彻底删除 微众银行分店
            $id = $request->get("id");                            //彻底删除 add by Neomor 彻底删除 微众银行分店
            try {                                                 //彻底删除 add by Neomor 彻底删除 微众银行分店
                $data = WeBankStore::where('id', $id)->first();   //彻底删除 add by Neomor 彻底删除 微众银行分店
                $storeunioninfos=DB::table('we_bank_storeunion')->where('store_id',$data['store_id']);
                Log::info($storeunioninfos);
                DB::table('we_bank_storeunion')->where('store_id',$data['store_id'])->delete();
                if (WeBankStore::where("id", $id)->delete()) {    //彻底删除 add by Neomor 彻底删除 微众银行分店
                    return json_encode(['success' => 1]);          //彻底删除 add by Neomor 彻底删除 微众银行分店
                }                                                  //彻底删除 add by Neomor 彻底删除 微众银行分店
            } catch (\Exception $exception) {                      //彻底删除 add by Neomor 彻底删除 微众银行分店
                return json_encode(['success' => 0]);              //彻底删除 add by Neomor 彻底删除 微众银行分店
            }                                                      //彻底删除 add by Neomor 彻底删除 微众银行分店
        }                                                          //彻底删除 add by Neomor 彻底删除 微众银行分店
    }                                                              //彻底删除 add by Neomor 彻底删除 微众银行分店
...
//        dd($data);
    ...
    public function orderlist(Request $request){
        ...
        $res=WebankStoreController::dataPaginator($request,$data);
