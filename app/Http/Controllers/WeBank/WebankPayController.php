...
class WebankPayController extends  WebankBaseController
{
    const WBPAY_CODE_PATH='/api/aap/server/wepay/publicpay';
    public function publicPay(Request $request){/**二维码支付宝GET调用*/
        Log::info('====== publicPay =======');
...
//            dd($res);
    ...
    public function doPay(Request $request){/**支付宝POST调用*/
        Log::info('====== doPay =======');
        Log::info($request);
        Log::info('====== doPay =======');
...
//                'userId'=>'2088102172192852',
    ...
    public function wxdoPay(Request $request){/**二维码微信POST调用*/
        Log::info('====== wxdoPay =======');
        Log::info($request);
        Log::info('====== wxdoPay =======');
...
//                    'trade_no'=>$result['channelNo'],
    ...
    public function weixinPay(Request $request){/**二维码微信GET调用*/
        Log::info('====== weixinPay =======');
        Log::info($request);
        Log::info('====== weixinPay =======');
        $store_id = $request->get('store_id');//商户号
...
//        Log::info(get_object_vars($request));
//        try{
//            Log::info($request);
